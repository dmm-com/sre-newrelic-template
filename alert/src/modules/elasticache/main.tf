...
// 内容：ホスト全体の CPU 使用率の割合 (%)。EngineCPUUtilization と似ているため、詳細は https://docs.aws.amazon.com/ja_jp/AmazonElastiCache/latest/red-ug/CacheMetrics.WhichShouldIMonitor.html#metrics-cpu-utilization を参照してください。
//
...
// 内容：Redis エンジンスレッドの CPU 使用率を提供します。CPUUtilization と似ているため、詳細は https://docs.aws.amazon.com/ja_jp/AmazonElastiCache/latest/red-ug/CacheMetrics.WhichShouldIMonitor.html#metrics-engine-cpu-utilization を参照してください。
//
